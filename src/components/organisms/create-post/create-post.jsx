...
const CreatePost = () => {
  ...
  return (
    <div className='flex flex-col shadow-md mb-4'>
      ...
      <button disabled={!content.content.length} onClick={addPost} className="post-button flex text-white justify-center p-3 mb-2 self-center rounded bg-indigo900 hover:bg-indigo700 cursor-pointer sm:w-auto items-center space-x-2">
              <FaPaperPlane />
